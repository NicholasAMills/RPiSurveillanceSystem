'''
    Class to hold username and password for email, along with recipient email as a QOL improvement.
...
class Login():
    ...
    def get_recipient():
        return 'receiving email here' # enter destination email inside the single quotes